...
import pt.edp.dlai.demo.common.ImageUtils
import pt.edp.dlai.demo.common.Utils
...
internal constructor(private val context: Context,
    ...
    @Throws(FirebaseMLException::class)
    @AddTrace(name="Classify imageproxy")
    ...
    @Throws(FirebaseMLException::class)
    @AddTrace(name="Classify FirebaseVisionImage")
